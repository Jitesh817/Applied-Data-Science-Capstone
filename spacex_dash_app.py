...
for booster_details in spacex_df['Booster Version']:
    detail_list = booster_details.split(' ')
    booster_version_category.append(detail_list[1])

spacex_df['Booster Version Category'] = booster_version_category
...
def get_pie_chart(entered_site):
    ...
    if entered_site != 'ALL':
        ...
        values = [filtered_df[filtered_df['class'] == 0].size, filtered_df[filtered_df['class'] == 1].size]
